...
Source CSV: `/home/jesse/oran_lab/logs/iq_width_sweep/20260530_215623/summary.csv`
...
|---:|---:|---|---:|---|---:|---|---|---:|---|---|---:|---:|---:|---:|---:|
| 9 | 1 | ok | 1 | vrtsim | 4049760000 | 24/24 | 24/24 | 1 | 1/1 | 41.938/30.700/42.500 | 150.769 | 150.777 | 4.990 | 0.000 | 52 |
| 16 | 0 | ok | 1 | vrtsim | 4049760000 | 24/24 | 24/24 | 1 | 1/1 | 32.300/32.100/32.400 | 254.027 | 254.040 | 2.799 | 0.000 | 51 |
...
- Channel setup (chanmod ON):
    ...
    - UE mobility (forgetfact PROXY; max_Doppler NOT implemented): `0.53225`
    - vrtsim timescale: `1.0`
- Measured RX SNR (UL, gNB): iq9=41.938dB(min 30.700/max 42.500), iq16=32.300dB(min 32.100/max 32.400)
