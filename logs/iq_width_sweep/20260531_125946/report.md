...
Source CSV: `/home/jesse/oran_lab/logs/iq_width_sweep/20260531_125946/summary.csv`
...
|---:|---:|---|---:|---|---:|---|---|---:|---|---|---:|---:|---:|---:|---:|
| 16 | 0 | ue-timeout | 1 | vrtsim | 4049760000 | 24/24 | 24/24 | 1 | 1/1 | 0.000/0.000/0.000 | 508.053 | 508.053 | 0.000 | 0.000 | 64 |
...
- Channel setup (chanmod ON):
    ...
    - UE mobility (forgetfact PROXY; max_Doppler NOT implemented): `0.08871`
    - vrtsim timescale: `1.0`
- Measured RX SNR (UL, gNB): iq16=0.000dB(min 0.000/max 0.000)
